            ...
            <div class="flex-grow h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Cari di {{ $this->searchableColumns()->map->label->join(', ') }}" />
            ...
            <div class="rounded-lg rounded-t-none max-w-screen rounded-lg border-b border-gray-200 bg-white">
                <div class="p-2 sm:flex items-center justify-between">
                    ...
                    <div class="flex justify-end text-gray-600">
                        Hasil {{ $this->results->firstItem() }} - {{ $this->results->lastItem() }} dari
                        {{ $this->results->total() }}
                    </div>
                    @endif
                </div>
